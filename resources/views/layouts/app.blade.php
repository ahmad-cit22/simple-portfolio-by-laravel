...
<head>
    ...
    <title>Simple Portfolio built with Laravel</title>
            ...
            <div class="row s-header__inner">
                ...
                <nav class="s-header__nav">
                    <ul class="s-header__menu-links">
                        <li class="current"><a class="" href="{{ route('home') }}">Home</a></li>
                        <li><a class="" href="{{ route('works') }}">Work Experiences</a></li>
        ...
        <footer id="footer" class="s-footer target-section">
            ...
            <div class="row s-footer__content">
                ...
                <div class="column xl-6 md-12 s-footer__block s-footer__about">
                    <p class="attention-getter">
                        I love to create modern, clean and functional website. I'm always open to new freelance
                        opportunities and project collaborations. If you have any question or you just want to chat,
                        feel free to send me an email at <a
                            href="mailto:{{ $homeContents['email'] }}">{{ $homeContents['email'] }}</a>.
                    </p>
                ...
                <div class="column xl-6 md-12 s-footer__block s-footer__site-links">
                    <div class="row">
                        ...
                        <div class="column xl-6 md-6 tab-12">
                            <h5>Contact Me</h5>
                            <ul class="link-list">
                                <li><a href="mailto:{{ $homeContents['email'] }}">{{ $homeContents['email'] }}
                                    </a></li>
                                <li><a href="tel:{{ $homeContents['phone'] }}">{{ $homeContents['phone'] }}</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row s-footer__buttons">
                ...
                <div class="column xl-6 tab-12">
                    <a href="mailto:{{ $homeContents['email'] }}" "
                        class="btn btn--primary btn--large u-fullwidth">Message Me</a>
                </div>
            ...
            <div class="row s-footer__bottom">
                        ...
                        <li>
                            <a href="#0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path
                                        d="
                        M20,3H4C3.447,3,3,3.448,3,4v16c0,0.552,0.447,1,1,1h8.615v-6.96h-2.338v-2.725h2.338v-2c0-2.325,1.42-3.592,3.5-3.592
                        c0.699-0.002,1.399,0.034,2.095,0.107v2.42h-1.435c-1.128,0-1.348,0.538-1.348,1.325v1.735h2.697l-0.35,2.725h-2.348V21H20
                        c0.553,0,1-0.448,1-1V4C21,3.448,20.553,3,20,3z">
                        </path>
                        </svg>
                ...
                <div class="column xl-6 lg-12">
                    <p class="ss-copyright">
                        ...
                        <span>Design template taken from <a href="https://styleshout.com/">StyleShout</a> Distribution
                            by <a href="https://themewagon.com">ThemeWagon</a></span>
                    </p>
                </div>
